...
int main(int argc, char * argv[]) try {
    ...
    std::cout <<"Your Object Name is: "<< obj_name << std::endl;
    ...
    while (!glfwWindowShouldClose(win)) {
        ...
        if (glfwGetKey(win, GLFW_KEY_SPACE) == GLFW_RELEASE && key_state >= 1) {
            ...
            std::string depth_file_aligned = data_path + obj_name + "_" + frame_name.str() + "_depth.jpg";
            ...
            std::string depth_file_raw = data_path + "raw/" + obj_name + "_" + frame_name.str() + "_depth.jpg";
            ...
            std::string color_file = data_path + obj_name + "_" + frame_name.str() + ".jpg";
